...
[![Version](https://img.shields.io/badge/version-3.4.0--rc.1-blue?style=for-the-badge)](https://github.com/sadeghanisi/SLR/releases)
...
Version `3.4.0-rc.1` fixes stale WebApp PDF counters/results/report visibility that could previously make processing appear complete without updating included/excluded/flagged counts or report links reliably.
...
| Web App counters/results/export look stale | Refresh the browser, check `/api/processing/results`, and review the server terminal/output log. Version `3.4.0-rc.1` fixes known stale counter/report visibility issues from earlier builds |
...
- `python benchmarks/run_benchmarks.py --quick` -> completed in 33.324 seconds.
